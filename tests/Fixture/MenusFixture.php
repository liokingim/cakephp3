...
class MenusFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'menu name', 'precision' => null, 'fixed' => null],
...
/*        [
          'id' => 1,
          'name' => 'Pizza',
          'created' => '2018-01-30 01:26:45',
          'modified' => '2018-01-30 01:26:45'
        ],*/
    ];
